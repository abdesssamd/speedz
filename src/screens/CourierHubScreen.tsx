...
const s = StyleSheet.create({
  ...
  headerIconWrap: { width: 56, height: 56, borderRadius: 28, backgroundColor: "#FFF3EC", alignItems: "center", justifyContent: "center", shadowColor: "#FF7622", shadowOpacity: 0.2, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 3 },
  pageTitle: { color: "#181C2E", fontSize: 24, fontWeight: "900" },
  pageSubtitle: { color: "#898989", fontSize: 13, lineHeight: 19 },

  loginCard: { backgroundColor: "#FFF", borderRadius: 24, padding: 18, gap: 14, shadowColor: "#000", shadowOpacity: 0.06, shadowRadius: 14, shadowOffset: { width: 0, height: 4 }, elevation: 3 },
  loginLabel: { color: "#181C2E", fontWeight: "800", fontSize: 15 },
  ...
  refreshBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: "#FF7622", borderRadius: 16, paddingVertical: 15, shadowColor: "#FF7622", shadowOpacity: 0.3, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 4 },
  btnDisabled: { opacity: 0.6 },
  refreshBtnText: { color: "#FFF", fontWeight: "900", fontSize: 14 },

  sectionHeader: { flexDirection: "row", alignItems: "center", gap: 10 },
  sectionTitle: { color: "#181C2E", fontSize: 20, fontWeight: "900", flex: 1 },
  ...
  jobCard: { backgroundColor: "#FFF", borderRadius: 22, padding: 18, gap: 12, shadowColor: "#000", shadowOpacity: 0.06, shadowRadius: 12, shadowOffset: { width: 0, height: 3 }, elevation: 2 },
  jobCardHeader: { flexDirection: "row", alignItems: "center", gap: 10 },
  jobAvailableBadge: { backgroundColor: "#DCFCE7", borderRadius: 999, paddingHorizontal: 10, paddingVertical: 4, borderWidth: 1, borderColor: "#BBF7D0" },
  jobAvailableText: { color: "#16A34A", fontWeight: "800", fontSize: 11 },
  jobActiveBadge: { alignSelf: "flex-start", backgroundColor: "#FFF3EC", borderRadius: 999, paddingHorizontal: 10, paddingVertical: 4, borderWidth: 1, borderColor: "#FFD5B8" },
  jobActiveText: { color: "#FF7622", fontWeight: "800", fontSize: 11 },
  jobRestaurant: { color: "#181C2E", fontSize: 17, fontWeight: "900", flex: 1 },
  jobInfoRow: { flexDirection: "row", alignItems: "center", gap: 6 },
  jobInfoLabel: { color: "#898989", fontSize: 12, fontWeight: "700" },
  jobInfoVal: { flex: 1, color: "#181C2E", fontSize: 13, fontWeight: "600" },
  jobFooter: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingTop: 8, borderTopWidth: 1, borderTopColor: "#F5F5F5" },
  gainLabel: { color: "#898989", fontSize: 11, fontWeight: "700", textTransform: "uppercase", letterSpacing: 0.5 },
  gainVal: { color: "#22C55E", fontWeight: "900", fontSize: 20, marginTop: 2 },
  acceptBtn: { flexDirection: "row", alignItems: "center", gap: 6, backgroundColor: "#181C2E", borderRadius: 14, paddingHorizontal: 16, paddingVertical: 12 },
  acceptBtnText: { color: "#FFF", fontWeight: "800", fontSize: 13 },

  histCard: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", backgroundColor: "#FFF", borderRadius: 18, padding: 16, shadowColor: "#000", shadowOpacity: 0.04, shadowRadius: 8, shadowOffset: { width: 0, height: 2 }, elevation: 1 },
  histLeft: { gap: 4 },
  histName: { color: "#181C2E", fontWeight: "800", fontSize: 14 },
  histDate: { color: "#898989", fontSize: 12 },
  histGain: { color: "#22C55E", fontWeight: "900", fontSize: 16 },
});
